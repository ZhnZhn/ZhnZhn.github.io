...
const isEstat = exports.isEstat = _fIsLoadId(LT_EU_STAT);
const isEmber = exports.isEmber = _fIsLoadId(LT_EMB);
const isEia = exports.isEia = _fIsLoadId(LT_EIA);
const isEcb = exports.isEcb = _fIsLoadId(LT_ECB);
