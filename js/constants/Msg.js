...
const ERR_FEATURE_WITHOUT_KEY = _crMsg(WITHOUT_API_KEY, _crForReqToken() + " a Quandl API key is required. Please register for a free Quandl account, " + AND_THEN_ENTER_KEY);
...
const ERR_10 = { ..._crMsg('Not Allowed to Add', "This type of request isn't allowed to be added to selected chart. It can be loaded in his own chart or view item."),
  token: 'ERR_10'
};
