...
var qeSources = ['CURRENCY_HISTORY', 'COMMODITY_PRICE', 'WIKI_COMMODITY_PRICE', 'LME', 'COMMODITY_TRADE', 'JODI_WORLD_GAS', 'JODI_WORLD_OIL', 'BP', 'PETROLEUM_PRICES', 'EIA_COAL', 'GLOBAL_INDICATOR', 'WORLDBANK_PRICE', 'IMF_CROSSCOUNTRY', 'EU_COMMISSION', 'OECD', 'USCENSUS_TRADE', 'OECD_CPI', 'RATE_INFLATION', 'BIG_MAC', 'GDT', 'BLSI', 'ROGERS_INDICES', 'BALTIC_INDICES', 'EURONEXT_STOCK', 'WIKI_STOCK', 'FREE_US_FUNDAMENTAL', 'BARCHART_STOCK', 'ALPHA_INDICATOR', 'ALPHA_SECTOR', 'TOKIO_STOCK', 'NIKKEI', 'UNICORN_RESEARCH', 'CHINA_FINANCE_FUTURE', 'DCE_FUTURE', 'ZCE_FUTURE', 'SHANGHAI_FUTURE', 'LIFFE_FUTURE', 'ICE_FUTURE', 'WIKI_FUTURE', 'ZILLOW_REAL_ESTATE', 'FMAC'];
