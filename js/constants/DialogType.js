...
var qeSources = ['CURRENCY_HISTORY', 'COMMODITY_PRICE', 'COMMODITY_TRADE', 'JODI_WORLD_GAS', 'JODI_WORLD_OIL', 'GLOBAL_INDICATOR', 'WORLDBANK_PRICE', 'IMF_CROSSCOUNTRY', 'CPI_INFLATION', 'BIG_MAC', 'WIKI_STOCK', 'TOKIO_STOCK', 'UNICORN_RESEARCH', 'CHINA_DCE_FUTURE', 'CHINA_ZCE_FUTURE', 'ZILLOW_REAL_ESTATE'];
