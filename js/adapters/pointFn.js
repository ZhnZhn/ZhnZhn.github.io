...
exports.crVolumePoint = exports.crVolumeColorPoint = exports.crAthPoint = void 0;
var _big = _interopRequireDefault(require("big.js"));
var _Color = require("../constants/Color");
const _assign = Object.assign;
const _crVolumeColor = (open, close) => open && close > open ? _Color.COLOR_GREEN : open && close < open ? _Color.COLOR_RED : _Color.COLOR_GREY;
const crVolumeColorPoint = (date, open, close, volume) => ({
  x: date,
  y: volume,
  color: _crVolumeColor(open, close)
});
exports.crVolumeColorPoint = crVolumeColorPoint;
