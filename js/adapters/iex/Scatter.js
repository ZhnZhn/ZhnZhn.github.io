...
Scatter.prototype = Object.assign(Scatter.prototype, {
  toConfig: function toConfig(json, option) {
    ...
    return (0, _ConfigBuilder2.default)().initBaseArea({ spacingTop: 25, isCrosshair: false }).addCaption(TITLE, crSubtitle(option)).addSeriaTo(0, crSeria(json, option)).add({ zhConfig: _toFns2.default.crZhConfig(option) }).toConfig();
  },
