...
describe('getRequestUrl', () => {
  ...
  test('should return valid url for crUrlN spline', () => {
    ...
    expect(url).toBe(_apiFn.STAT_API_URL + "/" + DF_TABLE + "?n1=v1&n2=v2" + _apiFn.QUERY_TAIL);
  });
  test('should return valid url for crUrlN category chart', () => {
    ...
    const options = {
      ...
      url = _EuroStatApi.default.getRequestUrl(options);
    expect(url).toBe(_apiFn.STAT_API_URL + "/" + DF_TABLE + "?n1=v1&n2=v2&time=" + time + _apiFn.DF_TAIL);
  });
});
