...
const getItemsValue = function (option, itemIndex) {
  if (itemIndex === void 0) {
    itemIndex = 0;
  }
  return (0, _getPropertyFn.getV)(option.items[itemIndex]);
};
exports.getItemsValue = getItemsValue;
