...
var FaoStatAdapter = {
  ...
  toConfig: function toConfig(json, option) {
    var _id = crId(option),
        ...
        config = (0, _ConfigBuilder2.default)().areaConfig({ spacingTop: 25 }).addCaption(_title, _subtitle).addPoints(_id, _points).addMinMax(_points, option).addTooltip(_Tooltip2.default.fnBasePointFormatter).add({
