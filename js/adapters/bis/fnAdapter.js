...
const _crItemIdDf = _ref => {
  ...
  return (0, _AdapterFn.joinBy)('.', dfPrefix, (0, _CategoryFn.isCategory)(seriaType) ? '*' : (0, _AdapterFn.getValue)(items[0]), (0, _AdapterFn.getValue)(items[1]));
};
const _crtemId312 = _ref2 => {
  let {
    items,
    seriaType
  } = _ref2;
