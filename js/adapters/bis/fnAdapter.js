...
const _crCategoryToken = (seriaType, item) => (0, _CategoryFn.isCategory)(seriaType) ? "*" : (0, _AdapterFn.getValue)(item),
  _crItemIdDf = _ref => {
    let {
      dfPrefix,
      items,
  ...
  _crItemId21 = _ref3 => {
    ...
    return (0, _arrFn.joinByDot)((0, _AdapterFn.getValue)(items[1]), (0, _AdapterFn.getValue)(items[0]), dfSuffix);
  },
...
const _fGetAttribute = (propName, transformValue) => element => element ? transformValue(element.getAttribute(propName)) : null;
...
const getRefArea = exports.getRefArea = _fGetAttribute("REF_AREA", _AdapterFn.FN_IDENTITY);
