...
exports.fCreateStackedColumnConfig = void 0;
...
var fCreateStackedColumnConfig = function fCreateStackedColumnConfig(json, option) {
  var chartType = option.seriaType,
      ...
      config = _ChartConfig["default"].fBaseStackedColumnConfig({
    stacking: stacking
  }),
...
exports.fCreateStackedColumnConfig = fCreateStackedColumnConfig;
