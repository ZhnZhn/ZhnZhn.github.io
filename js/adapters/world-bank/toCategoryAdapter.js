...
const _isCategoryId = (0, _arrFn.isInArrStr)(CATEGORY_IDS);
const _crData = (json, option) => {
    const _crValue = (0, _AdapterFn.fCrValue)(option),
      _data = json[1];
    return (0, _isTypeFn.isArr)(_data) ? (0, _compareByFn.sortDescCategory)(_data.reduce((data, point) => {
      const {
          country,
          value
        } = point || {},
      ...
      if (id && !REG_DIGIT.test(id) && !_isCategoryId(id) && (0, _isTypeFn.isNumber)(value)) {
