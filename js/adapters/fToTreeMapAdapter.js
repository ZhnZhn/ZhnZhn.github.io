...
exports.toTimeSeriesTreeMapAdapter = exports.fToTreeMapAdapter = exports.crItemColor = void 0;
...
const _crValue = (value, totalRt) => (0, _mathFn.roundBy)(value, (0, _crRoundedSubTotal.crItemRt)(value, totalRt));
...
const _crCaption = (data, option, total, totalRt, onePercent) => {
  const _arrTotal = data.reduce((arrTotal, _ref) => {
    ...
    [ffTotal, nffTotal] = (0, _crRoundedSubTotal.crRoundedSubTotal)(_arrTotal[0], _arrTotal[1], total, totalRt),
    [ffPerc, nffPerc] = (0, _crRoundedSubTotal.crRoundedSubTotal)(ffTotal / onePercent, nffTotal / onePercent, 100),
