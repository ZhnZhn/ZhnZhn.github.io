...
//data = [{ y, name, c}]
const crCategoryConfig = (title, subtitle, seriaType, seriaColor, data, isCluster, isAxisLabelsGrey) => (0, _pipe.default)((0, _configBuilderFn.crBarOrColumnConfig)(seriaType, (0, _CategoryFn.crCategories)(data), seriaColor, isAxisLabelsGrey ? void 0 : seriaColor), (0, _configBuilderFn.fAddCaption)(title, subtitle), (0, _configBuilderFn.fAddSeriaBy)(0, {
  color: seriaColor,
