...
describe('ymdhmsToUTC', function () {
  var fn = ymdhmsToUTC //'2010-01-01 12:00:00'
  ,
      UTC_MLS = 1262347200000;
  test('should retun mls UTC for str date', function () {
    expect(fn('2010-01-01 12:00:00')).toBe(UTC_MLS);
  });
  test('should retun mls UTC for str date with dtDelimeter', function () {
    expect(fn('2010-01-01T12:00:00', 'T')).toBe(UTC_MLS);
  });
  test('should retun mls UTC for str yyyy-mm-dd', function () {
    expect(fn('2010-01-01')).toBe(1262304000000);
  });
  test('should return NaN for edge case', function () {
    expect(fn()).toBeNaN();
