...
var _dateFormatFn = require("../dateFormatFn");
...
describe('toTdmyIf', () => {
  const fn = _dateFormatFn.toTdmyIf;
...
describe('toTdSafe', () => {
  const fn = _dateFormatFn.toTdSafe;
...
//# sourceMappingURL=dateFormatFn.test.js.map