...
describe("math sma", function () {
  ...
  test("should return correct sma toFixed 2 array for array points", function () {
    expect((0, _sma["default"])([[1, 0.7745], [2, 0.7844], [3, 0.78], [4, 0.78]])).toEqual([[2, 0.78], [3, 0.78], [4, 0.78]]); // JS 3*0.7 = 2.0999999999999996 < 2.1

    expect((0, _sma["default"])([[1, 0.7], [2, 0.7], [3, 0.7], [4, 0.7]], 3)).toEqual([[4, 0.7]]); // JS 3*0.2 = 0.6000000000000001 > 0.6

    expect((0, _sma["default"])([[1, 0.2], [2, 0.2], [3, 0.2], [4, 0.2]], 3)).toEqual([[4, 0.2]]);
  });
  ...
  test("should filter not number values", function () {
    expect((0, _sma["default"])([[1, 0.7], [2, void 0], [3, 'str'], [4, NaN], [5, null], [6, 0.7]])).toEqual([[6, 0.7]]);
  });
});
