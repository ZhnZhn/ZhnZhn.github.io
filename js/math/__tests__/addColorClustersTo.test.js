...
var _addColorClustersTo = _interopRequireDefault(require("../addColorClustersTo"));
  ...
  test('should add color clusters to data', () => {
    const data = [{
      ...
      y: 6.1
          ...
          _r = (0, _addColorClustersTo.default)(data, colors);
...
//# sourceMappingURL=addColorClustersTo.test.js.map