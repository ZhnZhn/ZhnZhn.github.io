...
const _withApiKey = [_LoadType.LT_Q, _LoadType.LT_AV, _LoadType.LT_AV_BLCH, _LoadType.LT_AV_ECON, _LoadType.LT_FMP, _LoadType.LT_INTR, _LoadType.LT_TW, _LoadType.LT_MSV, _LoadType.LT_BEA, _LoadType.LT_EIA, _LoadType.LT_WT];
...
const exportSettingFn = () => ({
  ...
  key10: _fSetKey(_LoadType.LT_MSV),
  setProxy: _setProxy,
  getProxy,
