...
const WithLogicDnD = {
  dragDropItem(watchList, _ref) {
    ...
    const dropArr = dropId.split(';'),
          ...
          dropIndex = dropArr[2] ? (0, _LogicFn.findIndex)(dropList.items, dropArr[2]) : 0; //dragArr[3] => dragArr[2]
