...
describe('useKeyEnter', () => {
  test('should return fn onKeyEnter depended of deps', () => {
    const onEnter = jest.fn() //1 Test return type
    ,
          {
      result,
      rerender
    ...
    (0, _reactHooks.act)(() => _onKeyEnter(_eventEnter));
    ...
    (0, _reactHooks.act)(() => _onKeyEnter(_eventBlank));
    expect(result.current).toEqual(_onKeyEnter);
    ...
    (0, _reactHooks.act)(() => _onKeyEnter(_eventNotEnter));
