...
var MenuBadge = function (_Component) {
  _inherits(MenuBadge, _Component);
  ...
  function MenuBadge() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MenuBadge.__proto__ || Object.getPrototypeOf(MenuBadge)).call.apply(_ref, [this].concat(args))), _this), _this._handleClickBadge = function (event) {
