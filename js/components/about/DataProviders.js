...
const OPEN_COLOR_L2 = _Color.default.GREEN;
const ST = {
  ROOT_CHILD: {
  ...
  OC_L1: { ..._About.default.LINE_HEIGHT,
    ..._About.default.P_BOTTOM
  },
  OC_L2: {
    paddingTop: 6,
    lineHeight: 1.8
...
const LinkList = ({
  ...
  const _isConfig = _isArr(CompOrConfig),
    ...
    per: CompOrConfig[1]
        ...
        style = _isConfig ? { ..._About.default.PROVIDER,
    ..._About.default.PR_4
  } : _About.default.PROVIDER;
