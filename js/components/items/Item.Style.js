...
const CL_VM_BADGE_BT = exports.CL_VM_BADGE_BT = (0, _styleFn.getScreenCase)("bt-sl-18", "bt");
const CL_HEADER_CAPTION = exports.CL_HEADER_CAPTION = (0, _styleFn.crNotSelectedCn)("text-clip bt-left bt black");
