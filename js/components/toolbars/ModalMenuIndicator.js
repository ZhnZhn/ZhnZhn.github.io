...
const FN_ROC = ['ROC', 'isGrowthRate', C_GROW, _seriaFn.growthRate, true],
  FN_DIFF = ['DIFF', 'isChanges', C_GROW, _seriaFn.changesBetween, true],
  FN_NORM = ['NORM', 'isNormalize', C_GROW, _seriaFn.normalize, false];
...
class ModalMenuIndicator extends _react.Component {
  ...
  */
  ...
  constructor(props) {
    ...
    const {
      btTitle
    } = (_config.zhMiniConfigs || [])[0] || {};
    this._isRsi = this._isMfi || (btTitle || '').indexOf('Volume') !== -1;
    this._addGrowRate = this._addSeriaBy.bind(this, FN_ROC);
    this._removeGrowRate = this._hideSeriaBy.bind(this, FN_ROC);
    this._addChanges = this._addSeriaBy.bind(this, FN_DIFF);
    this._removeChanges = this._hideSeriaBy.bind(this, FN_DIFF);
    this._addNormalize = this._addSeriaBy.bind(this, FN_NORM, {});
    this._removeNormalize = this._hideSeriaBy.bind(this, FN_NORM);
    this.state = {
      isGrowthRate: false,
      isNormalize: false,
      isMomAth: false
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ModalPopup.default, {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_RowType.default, {
          ...
          config: config,
          getChart: getChart
        }), this._isRsi && /*#__PURE__*/(0, _jsxRuntime.jsx)(_RowRsi.default, {
          config: config,
          getChart: getChart
