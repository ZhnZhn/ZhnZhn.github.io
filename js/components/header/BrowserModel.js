...
const PAGE_CONFIGS_01 = [[CL_ORG, 'DBnomics', _BrowserType.BT_DB_NOMICS], [CL_BR, 'Energy', _BrowserType.BT_ENERGY], [CL_ORG, 'EU: Comext', _BrowserType.BT_COMEXT], [CL_ORG, 'EU: FIGARO', _BrowserType.BT_FGR], [CL_ORG, 'Euro Indicators / PEEIs', _BrowserType.BT_PE], [CL_ORG, 'EU: SDG', _BrowserType.BT_SDG], [CL_ORG, 'Nasdaq Data Link', _BrowserType.BT_NDL], [CL_BR, 'U.S. Economics', _BrowserType.BT_US_ECONOMICS]],
