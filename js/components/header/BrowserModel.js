...
const PAGE_CONFIGS_01 = [[CL_ORG, 'DBnomics', _BrowserType.BT_DB_NOMICS], [CL_BR, 'Energy', _BrowserType.BT_ENERGY], [CL_ORG, 'Nasdaq Data Link', _BrowserType.BT_NDL], [CL_BR, 'U.S. Economics', _BrowserType.BT_US_ECONOMICS], [CL_BR, 'Commodities', _BrowserType.BT_COMMODITIES]],
  PAGE_CONFIGS_02 = [[CL_ORG, 'Overview', _BrowserType.BT_EUROSTAT], [CL_ORG, 'Circular Economy', _BrowserType.BT_CEI], [CL_ORG, 'Euro Indicators / PEEIs', _BrowserType.BT_PE], [CL_ORG, 'EU Comext', _BrowserType.BT_COMEXT], [CL_ORG, 'EU FIGARO', _BrowserType.BT_FGR], [CL_ORG, 'EU SDG', _BrowserType.BT_SDG]],
  PAGE_CONFIGS_03 = [[CL_ORG, 'Insee: France Statistics', _BrowserType.BT_FRANCE_STATISTICS], [CL_ORG, 'ONS: UK Statistics', _BrowserType.BT_UK_STATISTICS], [CL_ORG, 'Statistics Norway', _BrowserType.BT_NORWAY_STATISTICS], [CL_ORG, 'Statistics Norway All', _BrowserType.BT_NORWAY_STAT_ALL], [CL_ORG, 'Statistics Sweden', _BrowserType.BT_SWEDEN_STAT], [CL_ORG, 'Statistics Sweden All', _BrowserType.BT_SWEDEN_STAT_ALL], [CL_ORG, 'Statistics Finland All', _BrowserType.BT_FINLAND_STAT_ALL], [CL_ORG, 'Statistics Denmark All', _BrowserType.BT_DENMARK_STAT_ALL], [CL_ORG, 'CSO Ireland All', _BrowserType.BT_IRELAND_STAT_ALL]],
  ...
  PAGE_CONFIGS_05 = [[CL_ORG, 'FAOSTAT', _BrowserType.BT_FAOSTAT], [CL_ORG, 'UN Comtrade', _BrowserType.BT_UN_COMTRADE], [CL_ORG, 'World Bank', _BrowserType.BT_WORLD_BANK]];
