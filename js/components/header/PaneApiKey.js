...
const CONF_SM_ARR = [["AV", "alpha-vantage", "Alpha Vantage"], ["FMP", "fmp", "Financial Modeling Prep", "32"], ["Intrinio", "intrinio", "Intrinio", "32"], ["Twelve", "twelve", "Twelve Data"], ["Massive", "massive", "Massive"]];
...
const PaneApiKey = _ref0 => {
  ...
  const _ref1 = (0, _uiApi.useRef)(),
    ...
    [_refs, fSetApiKey, _hSetAll, _hClearAll] = (0, _uiApi.useMemo)(() => [[_ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _ref10, _ref11], i => (0, _objFn.getFnByPropName)(data, 'key' + i), () => {
