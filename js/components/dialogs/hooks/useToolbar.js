...
const useToolbar = _ref => {
  ...
  return (0, _useProperty.useRefInit)(() => (0, _arrFn.filterBoolean)([toggleLabels ? (0, _crToolbarItem.default)('L', `${CLICK_TO_TOGGLE} input labels`, toggleLabels) : void 0, toggleInputs ? (0, _crToolbarItem.default)('T', `${CLICK_TO_TOGGLE} inputs`, toggleInputs) : void 0, toggleOptions ? (0, _crToolbarItem.default)('O', `${CLICK_TO_TOGGLE} dialog options`, toggleOptions) : void 0, toggleDate ? (0, _crToolbarItem.default)('D', `${CLICK_TO_TOGGLE} date input`, toggleDate) : void 0, (0, _crToolbarItem.default)('A', 'About data source', onAbout)]));
};
