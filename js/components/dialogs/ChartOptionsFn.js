...
const _crDF = (captions, mapFrequency) => {
  ...
  return _crDF3(oneCaption, mapFrequency).concat(_crItems([[_crCaptionMapBy(oneCaption), _ChartType.CHT_MAP, void 0, _CompItemType.CIT_EUROSTAT_MAP]]));
};
...
const _crColumBarItems = oneCaption => _crItems([[_crCaptionColumnBy(oneCaption), _ChartType.CHT_COLUMN_SET, oneCaption], [_crCaptionBarBy(oneCaption), _ChartType.CHT_BAR_SET, oneCaption]]);
const _crColumBarClusterItems = oneCaption => _crItems([[_crCaptionColumnBy(oneCaption), _ChartType.CHT_COLUMN_SET, oneCaption], [_crCaptionColumnBy(oneCaption, !0), _ChartType.CHT_COLUMN_CLUSTER, oneCaption], [_crCaptionBarBy(oneCaption), _ChartType.CHT_BAR_SET, oneCaption], [_crCaptionBarBy(oneCaption, !0), _ChartType.CHT_BAR_CLUSTER, oneCaption]]);
...
const _crTreeMapItem = (caption, id) => _crItem([_crCaptionTreeMapBy(caption), _ChartType.CHT_TREE_MAP, caption, void 0, id]);
const _crBarTreeMapItem = (caption, id) => _crItem([_crCaptionBarBy(caption), _ChartType.CHT_BAR_TREE_MAP, caption, void 0, id]);
const _crT3A = _ref5 => {
  let [oneCaption] = _ref5;
  return [..._crT3([oneCaption]), _crTreeMapItem(oneCaption), _crItem([_crCaptionTreeMapBy(oneCaption, !0), _ChartType.CHT_TREE_MAP_CLUSTER, oneCaption])];
};
const _crT3AB = _ref6 => {
...
const _crT3AC = _ref8 => {
  ...
  return [..._crT3([oneCaption]), _crItem([_crCaptionTreeMap6090(oneCaption), _ChartType.CHT_TREE_MAP_CLUSTER, oneCaption])];
};
