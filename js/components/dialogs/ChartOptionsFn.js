...
const _isArr = Array.isArray,
  BLANK_CAPTION = "",
  DIM_CAPTION = "Dim",
  CATEGORY_TYPES = [_ChartType.CHT_MAP, _ChartType.CHT_COLUMN_SET, _ChartType.CHT_BAR_SET, _ChartType.CHT_BAR_WITH_LABELS, _ChartType.CHT_DOT_SET, _ChartType.CHT_TREE_MAP, _ChartType.CHT_TREE_MAP_CLUSTER, _ChartType.CHT_BAR_TREE_MAP],
...
const _crT2AE = (captions, mapFrequency) => [..._crT2A(captions, mapFrequency), ..._crColumBarItems(DIM_CAPTION)];
const _crT3 = _ref => {
  let [oneCaption] = _ref;
...
const _crT3B = (_ref4, mapFrequency) => {
  ...
  return [..._crT2(), _crYearlyByMonthItem(mapFrequency), ..._crColumBarItems(oneCaption)];
};
