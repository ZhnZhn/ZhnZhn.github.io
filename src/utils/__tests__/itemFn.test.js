...
describe('getValue', ()=>{
  ...
  test('should return option dfValue or empty str in case value null or undefined', ()=>{
    expect(fn({ value: void 0 }, 'dfValue')).toBe('dfValue')
    expect(fn({ v: void 0 }, 0)).toBe('0')
    expect(fn({ value: null }, '')).toBe('')
    expect(fn({ v: null }, 'dfStr')).toBe('dfStr')
